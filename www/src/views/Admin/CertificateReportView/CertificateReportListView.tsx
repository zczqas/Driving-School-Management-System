...
import CertificateListTable from "./components/CertificateReportListTable";
...
// ==============================|| CERTIFICATE REPORT LIST VIEW ||============================== //
const CertificateReportListView = () => {
  ...
  React.useEffect(() => {
    if (role === "INSTRUCTOR") {
      ...
      dispatch(getAssignedUserCertificate(0, 30, "GOLD", "ISSUED"));
    }
      ...
      updateUserCertificateStatus(
        ...
        () => {
          if (role === "INSTRUCTOR") {
            ...
            dispatch(
              getAssignedUserCertificate(0, 30, certificateType, "ISSUED")
            );
          }
        }
      )
...
export default CertificateReportListView;
